...
|---|---|---|---|---|
| 1 | **Chart series twins.** Tokyo Night series 5 was the same orange as series 3 (Anthropic and Factory read as one band in stacked bars); Everforest series 2 duplicated series 1's green; Nord 3 and Ayu 5 were near-twins of neighbors. | P1, P4 | S1 | New distinct hues in `ThemeCatalog` (Tokyo Night teal, Everforest yellow, Nord aurora yellow, Ayu teal). Full ramp audit recorded in [08 §2](08-design-tokens.md); Matrix exempt as deliberate monochrome. |
