...
Use **Settings → About & updates**. QuotaBoard checks only when you select
**Check for updates**. Download and restart are separate actions. Moving the
portable folder can require you to enable startup again.
