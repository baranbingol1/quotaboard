...
public sealed class WindowsStartupRegistrationTests : IDisposable
{
    ...
    public void Raw_publish_keeps_current_executable()
    {
        ...
        Assert.Equal(Path.GetFullPath(executable), WindowsStartupRegistration.ResolveLauncherPath(executable));
    }
    ...
    public void Velopack_current_resolves_stable_root_launcher()
    {
        ...
        string resolved = WindowsStartupRegistration.ResolveLauncherPath(executable);
